...
class DocShareMixin(SimpleDocShareMixin):
    ...
    def add_share(self, for_user_id, additional_updates=None, auto_save=True,
        ...
        super(DocShareMixin, self).add_share(for_user_id=for_user_id,
                                             additional_updates=additional_updates,
                                             auto_save=auto_save)
    ...
    def remove_shares(self, for_user_ids, auto_save=True):
        ...
        super(DocShareMixin, self).remove_shares(for_user_ids=for_user_ids,
                                                 additional_updates=additional_updates,
                                                 auto_save=auto_save)
...
class BasePendingSharesMixin(object):
