...
# from mongo_sharing.documents.embedded import BaseShareEmbeddedDocument
# from mongo_sharing.documents.embedded import BaseSharePendingEmbeddedDocument
# from mongo_sharing.mixins import BasePendingSharesMixin
# from mongo_sharing.mixins import DocShareMixin
# from mongo_sharing.mixins import SimpleDocShareMixin
# from mongo_testing.auth import User
# from mongo_testing.testcase import MongoTestCase
# from mongo_tools.documents.models import AbstractBaseDocument
...
class SimpleDocSharesMixinTests(TestCase):

#    @classmethod
#    def setUpClass(cls):
#        """Run once per test case"""
#        super(SimpleDocSharesMixinTests, cls).setUpClass()
#        cls.usr = User.objects.create_user('john', 'john@doe.com', 'test')

#    def setUp(self):
#        """Run once per test."""
#        self.doc = MockSimpleDocSharesMixinModel.objects.create()
